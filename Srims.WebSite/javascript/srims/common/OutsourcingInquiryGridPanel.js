...
Srims.common.OutsourcingInquiryGridPanel = function(id, outsourcingStore, title,
		iconCls, queryParams) {
    // fields
    ...
    this._toolbar = new Srims.common.OutsourcingInquiryGridPanel_ToolBar(
    ...
    // constructor
    Srims.common.OutsourcingInquiryGridPanel.superclass.constructor.call(this, {
        id: id,
        stateful: true,
    ...
    function onCellDblClick(grid, rowIndex, columnIndex, e) {
        ...
        Srims.common.OutsourcingAction.ShowOutsourcing(outsourcing, this._outsourcingStore);
    }
}
Ext.extend(Srims.common.OutsourcingInquiryGridPanel, Ext.grid.GridPanel);