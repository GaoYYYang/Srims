...
Srims.common.EmailEditWindow = function(id, title, iconCls, emails) {
    ...
    Srims.common.EmailEditWindow.superclass.constructor.call(this, {
        id: id,
        title: title,
        iconCls: iconCls,
        labelWidth: 50,
...
Ext.extend(Srims.common.EmailEditWindow, Ext.Window);
