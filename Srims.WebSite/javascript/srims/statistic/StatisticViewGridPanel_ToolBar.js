...
Srims.statistic.StatisticViewGridPanel_ToolBar = function(selection, store, project){
    ...
    this._buttonNew = new Ext.Toolbar.Button({
        ...
        handler: function(){
            Srims.statistic.newProjectMember(this.project, this.store);
        },
        hidden: true,
        tooltip: '<b>新建项目成员</b>'
    });
    this._buttonEdit = new Ext.Toolbar.Button({
        ...
        handler: function(){
            if (this.selection.getCount() == 0) 
                return;
            Srims.statistic.editProjectMember(this.project, this.selection.getSelected(), this.store);
        },
        hidden: true,
        tooltip: '<b>编辑项目成员</b>'
    });
        ...
        handler: function(){
            ...
            Ext.MessageBox.confirm('删除项目成员', '你确定要删除这个项目成员吗？', function(buttonId){
                if (buttonId == 'yes') {
                    ...
                    Ext.Ajax.request({
                        url: Srims.service.statistic.ProjectMemberService + '/Delete',
                        params: _params,
                        scope: this,
                        success: function(){
                            this.store.load();
    ...
    Srims.statistic.ProjectGridPanel_ToolBar.superclass.constructor.call(this, {
...
Ext.extend(Srims.statistic.StatisticViewGridPanel_ToolBar, Ext.Toolbar);
