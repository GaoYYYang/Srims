<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoucherPrint.aspx.cs" Inherits="Srims.WebSite.VoucherPrint" %>
                ...
                <td>
                    <table class="tableDetial" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="data " style="width: 100px;">
                                <asp:Literal ID="CompusIndirectFee" runat="server"></asp:Literal>
                            </td>
                            <td class="label" style="width: 70px;">
                                课题组间接费用
                            </td>
